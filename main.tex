...
The changes in reliability over time for each network are visualized in \ref{fig2}. Note that because we have defined reliable URLs to be those considered both responsive and stable, they always represent the smallest fraction of URLs in \ref{table1}, \ref{fig2}, and \ref{fig3} visualizes the cumulative growth of biodiversity data networks during their periods of observation. This growth is illustrated with two metrics: the total number of unique URLs ever registered by each network and the total number of unique contents that had been downloaded from the network at each sampled point in time.
...
We have shown that software agents such as Preston can be used to collect datasets and their provenance over time while maintaining content-addressability; all that is needed to ensure proper data preservation are a dedicated repository and a well-known, publicly available search index to map content-based identifiers to datasets located in the repository. In practice, repositories and search indexes (and potentially software agents such as Preston deployments) can be co-located; examples include Zenodo and the Internet Archive, although they impose some limitations that may restrict file size, number of files, and the amount of information that can be indexed (Zenodo 2019, Internet Archive 2019). These existing information systems may serve as models for long-term biodiversity information systems. 
...
---- reference to be transcribed ----
International DOI Foundation, Operating Procedures, 2016. https://www.doi.org/doi_handbook/9_OperatingProcedures.html#9.2  

Jorrit H. Poelen (2019a). A biodiversity dataset graph: GBIF, iDigBio, BioCASe (Version 0.0.2) [Data set]. Zenodo. http://doi.org/10.5281/zenodo.3484205. 

Jorrit H. Poelen (2019b). A biodiversity dataset graph: BHL (Version 0.0.2) [Data set]. Zenodo. http://doi.org/10.5281/zenodo.3484555. 

Jorrit H. Poelen (2019c). A biodiversity dataset graph: DataONE (Version 0.0.3) [Data set]. Zenodo. http://doi.org/10.5281/zenodo.3483218. 

Jorrit H. Poelen (2019d). Biodiversity Dataset Archive [Data set]. Internet Archive. https://archive.org/details/biodiversity-dataset-archives 

Jorrit H. Poelen 2019. “To Connect Is to Preserve: On Frugal Data Integration and Preservation Solutions.” OSF. June 4. doi:10.17605/OSF.IO/A2V8G. 

NIST. Descriptions of SHA-256, SHA-384, and SHA-512. 2001 https://web.archive.org/web/20130526224224/http://csrc.nist.gov/groups/STM/cavp/documents/shs/sha256-384-512.pdf 

Biodiversity Heritage Library (BHL), 2019. https://www.biodiversitylibrary.org/ 

DataONE, 2019. https://www.dataone.org/ 

GBIF, 2019. https://www.gbif.org/ 

iDigBio, 2019. https://www.idigbio.org/  

GBIF.org (2019), GBIF Citation Guidelines. Available from: https://www.gbif.org/citation-guidelines [13 August 2018]. 

iDigBio Citation Guidelines, 2016. - https://www.idigbio.org/content/idigbio-terms-use-policy 

DataONE Citation Guidelines, 2012. - https://www.dataone.org/citing-dataone 

Zenodo, General Policies, 2019 https://about.zenodo.org/policies/ 

Internet Archive, 2019 https://help.archive.org/hc/en-us/articles/360002360111-Uploading-A-Basic-Guide 

Paskin, Norman, Digital Object Identifier (DOI®) System, 2010. http://0-www.doi.org.library.touro.edu/overview/DOI-ELIS-Paskin.pdf 

“Domain Names - Concepts and Facilities.” IETF, 1987. Accessed November 19, 2019. https://tools.ietf.org/html/rfc1034. 

Davis, Elisabeth B., and Diane Schmidt. 1996. Guide to Information Sources in the Botanical Sciences. Vol. 2nd ed. Reference Sources in Science and Technology. Englewood, Colo: Libraries Unlimited. http://search.ebscohost.com/login.aspx?direct=true&AuthType=ip,uid&db=nlebk&AN=18394&site=eds-live. 

FORCE11  https://www.force11.org/datacitationprinciples 

Dougherty M.V. (2018) Defining the Scholarly Record. In: Correcting the Scholarly Record for Research Integrity. Research Ethics Forum, vol 6. Springer, Cham 

Garfield, E., Irving, S. H., and Torpie, R. J, 1964. THE USE OF CITATION DATA IN WRITING THE HISTORY OF SCIENCE. https://apps.dtic.mil/docs/citations/AD0466578 

Berners-Lee, T., 1994. Uniform Resource Locators (URL). https://www.w3.org/Addressing/URL/url-spec.txt 

Berners-Lee, T., 1994. Uniform Resource Identifier (URI): Generic Syntax. https://tools.ietf.org/html/rfc3986 
