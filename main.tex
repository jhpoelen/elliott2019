...
No systematic approach has yet been adopted to reliably reference and provide access to our digital biodiversity datasets.
% Methodology
Based on accumulated evidence, we argue that location-based identifiers such as URLs are not sufficient to ensure long-term data access. We introduce a method that uses dedicated data observatories to evaluate long-term URL reliability.
...
% Discussion part 1
We propose the use of cryptograhpic hashing to generate content-based identifiers that can reliably reference datasets.
% Discussion part 2
We show that content-based identifiers facilitate decentralized archival and reliable long-term distribution of biodiversity datasets. Among other potential benefits, our proposed identifiers enable reliable dataset citations and long-term reproducibility of biodiversity studies.
\end{abstract}
