...
From March 2019 through May 2020, we took periodic inventories of the data provided to major biodiversity aggregators, including GBIF, iDigBio, DataONE, and BHL by accessing the URL-based dataset references from which the aggregators upload data. Over the period of observation, we found that, for each aggregator, 5\% to 43\% of registered provider URLs were intermittently or consistently unresponsive, 0\% to 63\% produced unstable content, and 13\% to 76\% became either unresponsive or unstable.
