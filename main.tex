...
1. Stability is not a quality assessment
2. Most dataset URLs are expected to be unstable
3. Stability of a data network is more a reflection of the purpose of the network
4. Still, whatever is being referenced needs to be stable. The data networks are fine, common citation practices are not
